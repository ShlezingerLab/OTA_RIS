...
from gan import plot_distribution
...
def test_physical_channel(teacher, SNR, H_d_all):
    ...
    with torch.no_grad():
        ...
        with torch.no_grad():
            ...
            final_kl_path = "test_demo_kl.png"
            plot_distribution(normalize_complex_batch(y_wireless), normalize_complex_batch(y_complex_gen), final_kl_path)
